...
additionalProperties:
  packageGuid: '{89FC0AC7-8B84-4F40-97E4-496D7F92C46E}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IGetSearchEnginesApiResponse apiResponse = await api.GetSearchEnginesAsync("todo");
            GetSearchEngines200Response? model = apiResponse.Ok();
        }
...
## Api Information
- appName: UAPI OpenAPI
- appVersion: 1.0.0
- appDescription: Generated from UAPI JSON. Code is the interactive documentation: rich descriptions, examples, and x-extensions preserved.
