...
namespace uapi-sdk-csharp.Model
{
    ...
    public partial class GetSocialQqGroupinfo200Response : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GetSocialQqGroupinfo200Response(Option<int?> activeMemberNum = default, Option<string?> avatarUrl = default, Option<string?> certText = default, Option<int?> certType = default, Option<int?> createTime = default, Option<string?> createTimeStr = default, Option<string?> description = default, Option<int?> groupGrade = default, Option<string?> groupId = default, Option<string?> groupMemo = default, Option<string?> groupName = default, Option<string?> joinUrl = default, Option<string?> lastUpdated = default, Option<int?> maxMemberCount = default, Option<int?> memberCount = default, Option<string?> ownerUid = default, Option<string?> ownerUin = default, Option<string?> tag = default)
        {
    ...
    public class GetSocialQqGroupinfo200ResponseJsonConverter : JsonConverter<GetSocialQqGroupinfo200Response>
    {
        ...
        public override GetSocialQqGroupinfo200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new GetSocialQqGroupinfo200Response(activeMemberNum, avatarUrl, certText, certType, createTime, createTimeStr, description, groupGrade, groupId, groupMemo, groupName, joinUrl, lastUpdated, maxMemberCount, memberCount, ownerUid, ownerUin, tag);
        }
