...
namespace uapi-sdk-csharp.Model
{
    ...
    public partial class GetMiscHolidayCalendar200Response : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GetMiscHolidayCalendar200Response(Option<List<GetMiscHolidayCalendar200ResponseDaysInner>?> days = default, Option<List<GetMiscHolidayCalendar200ResponseHolidaysInner>?> holidays = default, Option<string?> mode = default, Option<GetMiscHolidayCalendar200ResponseNearby?> nearby = default, Option<GetMiscHolidayCalendar200ResponseQuery?> query = default, Option<GetMiscHolidayCalendar200ResponseSummary?> summary = default)
        {
            DaysOption = days;
    ...
    public class GetMiscHolidayCalendar200ResponseJsonConverter : JsonConverter<GetMiscHolidayCalendar200Response>
    {
        ...
        public override GetMiscHolidayCalendar200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new GetMiscHolidayCalendar200Response(days, holidays, mode, nearby, query, summary);
        }
