...
namespace uapi-sdk-csharp.Model
{
    ...
    public partial class GetGameMinecraftHistoryid200Response : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GetGameMinecraftHistoryid200Response(Option<int?> count = default, Option<List<GetGameMinecraftHistoryid200ResponseHistoryInner>?> history = default, Option<string?> id = default, Option<int?> nameNum = default, Option<string?> query = default, Option<List<GetGameMinecraftHistoryid200ResponseResultsInner>?> results = default, Option<string?> uuid = default)
        {
            CountOption = count;
    ...
    public class GetGameMinecraftHistoryid200ResponseJsonConverter : JsonConverter<GetGameMinecraftHistoryid200Response>
    {
        ...
        public override GetGameMinecraftHistoryid200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new GetGameMinecraftHistoryid200Response(count, history, id, nameNum, query, results, uuid);
        }
