...
namespace uapi-sdk-csharp.Model
{
    ...
    public partial class PostAiTranslateRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PostAiTranslateRequest(string text, Option<ContextEnum?> context = default, Option<bool?> preserveFormat = default, Option<string?> sourceLang = default, Option<StyleEnum?> style = default)
        {
            Text = text;
    ...
    public class PostAiTranslateRequestJsonConverter : JsonConverter<PostAiTranslateRequest>
    {
        ...
        public override PostAiTranslateRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PostAiTranslateRequest(text.Value!, context, preserveFormat, sourceLang, style);
        }
