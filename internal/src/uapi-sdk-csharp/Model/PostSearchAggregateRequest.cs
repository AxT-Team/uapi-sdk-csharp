...
namespace uapi-sdk-csharp.Model
{
    ...
    public partial class PostSearchAggregateRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PostSearchAggregateRequest(string query, Option<bool?> fetchFull = default, Option<string?> filetype = default, Option<string?> site = default, Option<SortEnum?> sort = default, Option<TimeRangeEnum?> timeRange = default)
        {
            Query = query;
    ...
    public class PostSearchAggregateRequestJsonConverter : JsonConverter<PostSearchAggregateRequest>
    {
        ...
        public override PostSearchAggregateRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PostSearchAggregateRequest(query.Value!, fetchFull, filetype, site, sort, timeRange);
        }
