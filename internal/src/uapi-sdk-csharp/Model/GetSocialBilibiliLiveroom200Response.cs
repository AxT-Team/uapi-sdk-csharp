...
namespace uapi-sdk-csharp.Model
{
    ...
    public partial class GetSocialBilibiliLiveroom200Response : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GetSocialBilibiliLiveroom200Response(Option<decimal?> areaId = default, Option<string?> areaName = default, Option<decimal?> attention = default, Option<string?> background = default, Option<string?> description = default, Option<List<string>?> hotWords = default, Option<bool?> isPortrait = default, Option<string?> keyframe = default, Option<decimal?> liveStatus = default, Option<string?> liveTime = default, Option<GetSocialBilibiliLiveroom200ResponseNewPendants?> newPendants = default, Option<decimal?> online = default, Option<decimal?> parentAreaId = default, Option<string?> parentAreaName = default, Option<decimal?> roomId = default, Option<decimal?> shortId = default, Option<string?> tags = default, Option<string?> title = default, Option<decimal?> uid = default, Option<string?> userCover = default)
        {
            AreaIdOption = areaId;
    ...
    public class GetSocialBilibiliLiveroom200ResponseJsonConverter : JsonConverter<GetSocialBilibiliLiveroom200Response>
    {
        ...
        public override GetSocialBilibiliLiveroom200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new GetSocialBilibiliLiveroom200Response(areaId, areaName, attention, background, description, hotWords, isPortrait, keyframe, liveStatus, liveTime, newPendants, online, parentAreaId, parentAreaName, roomId, shortId, tags, title, uid, userCover);
        }
