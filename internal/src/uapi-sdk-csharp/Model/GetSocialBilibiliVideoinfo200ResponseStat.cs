...
namespace uapi-sdk-csharp.Model
{
    ...
    public partial class GetSocialBilibiliVideoinfo200ResponseStat : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GetSocialBilibiliVideoinfo200ResponseStat(Option<decimal?> aid = default, Option<decimal?> coin = default, Option<decimal?> danmaku = default, Option<decimal?> dislike = default, Option<string?> evaluation = default, Option<decimal?> favorite = default, Option<decimal?> hisRank = default, Option<decimal?> like = default, Option<decimal?> nowRank = default, Option<decimal?> reply = default, Option<decimal?> share = default, Option<decimal?> view = default, Option<decimal?> vt = default)
        {
            AidOption = aid;
            CoinOption = coin;
    ...
    public class GetSocialBilibiliVideoinfo200ResponseStatJsonConverter : JsonConverter<GetSocialBilibiliVideoinfo200ResponseStat>
    {
        ...
        public override GetSocialBilibiliVideoinfo200ResponseStat Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new GetSocialBilibiliVideoinfo200ResponseStat(aid, coin, danmaku, dislike, evaluation, favorite, hisRank, like, nowRank, reply, share, view, vt);
        }
