...
namespace uapi-sdk-csharp.Model
{
    ...
    public partial class GetSocialBilibiliVideoinfo200ResponsePagesInner : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GetSocialBilibiliVideoinfo200ResponsePagesInner(Option<decimal?> cid = default, Option<GetSocialBilibiliVideoinfo200ResponsePagesInnerDimension?> dimension = default, Option<decimal?> duration = default, Option<string?> from = default, Option<decimal?> page = default, Option<string?> part = default, Option<string?> vid = default, Option<string?> weblink = default)
        {
            CidOption = cid;
    ...
    public class GetSocialBilibiliVideoinfo200ResponsePagesInnerJsonConverter : JsonConverter<GetSocialBilibiliVideoinfo200ResponsePagesInner>
    {
        ...
        public override GetSocialBilibiliVideoinfo200ResponsePagesInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new GetSocialBilibiliVideoinfo200ResponsePagesInner(cid, dimension, duration, from, page, part, vid, weblink);
        }
