...
namespace uapi-sdk-csharp.Model
{
    ...
    public partial class GetSocialBilibiliUserinfo200Response : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GetSocialBilibiliUserinfo200Response(Option<int?> archiveCount = default, Option<int?> articleCount = default, Option<string?> birthday = default, Option<string?> face = default, Option<int?> follower = default, Option<int?> following = default, Option<int?> level = default, Option<int?> mid = default, Option<string?> name = default, Option<string?> sex = default, Option<string?> sign = default, Option<int?> vipStatus = default, Option<int?> vipType = default)
        {
    ...
    public class GetSocialBilibiliUserinfo200ResponseJsonConverter : JsonConverter<GetSocialBilibiliUserinfo200Response>
    {
        ...
        public override GetSocialBilibiliUserinfo200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new GetSocialBilibiliUserinfo200Response(archiveCount, articleCount, birthday, face, follower, following, level, mid, name, sex, sign, vipStatus, vipType);
        }
