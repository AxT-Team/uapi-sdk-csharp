...
namespace uapi-sdk-csharp.Model
{
    ...
    public partial class GetNetworkPingmyip200Response : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GetNetworkPingmyip200Response(Option<string?> clientIp = default, Option<string?> message = default, Option<bool?> pingSuccessful = default)
        {
    ...
    public class GetNetworkPingmyip200ResponseJsonConverter : JsonConverter<GetNetworkPingmyip200Response>
    {
        ...
        public override GetNetworkPingmyip200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new GetNetworkPingmyip200Response(clientIp, message, pingSuccessful);
        }
