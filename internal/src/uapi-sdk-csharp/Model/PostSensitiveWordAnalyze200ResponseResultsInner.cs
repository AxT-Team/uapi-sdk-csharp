...
namespace uapi-sdk-csharp.Model
{
    ...
    public partial class PostSensitiveWordAnalyze200ResponseResultsInner : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PostSensitiveWordAnalyze200ResponseResultsInner(Option<CategoryEnum?> category = default, Option<decimal?> confidence = default, Option<string?> k = default, Option<LabelEnum?> label = default)
        {
    ...
    public class PostSensitiveWordAnalyze200ResponseResultsInnerJsonConverter : JsonConverter<PostSensitiveWordAnalyze200ResponseResultsInner>
    {
        ...
        public override PostSensitiveWordAnalyze200ResponseResultsInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PostSensitiveWordAnalyze200ResponseResultsInner(category, confidence, k, label);
        }
