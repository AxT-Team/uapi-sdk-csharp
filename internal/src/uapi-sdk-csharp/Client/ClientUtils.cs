...
[assembly: InternalsVisibleTo("uapi-sdk-csharp.Test")]
...
namespace uapi-sdk-csharp.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is PostTextMarkdownToHtmlRequest.FormatEnum postTextMarkdownToHtmlRequestFormatEnum)
                return PostTextMarkdownToHtmlRequest.FormatEnumToJsonValue(postTextMarkdownToHtmlRequestFormatEnum);
            if (obj is PostTextMarkdownToPdfRequest.PaperSizeEnum postTextMarkdownToPdfRequestPaperSizeEnum)
                return PostTextMarkdownToPdfRequest.PaperSizeEnumToJsonValue(postTextMarkdownToPdfRequestPaperSizeEnum);
            if (obj is PostTextMarkdownToPdfRequest.ThemeEnum postTextMarkdownToPdfRequestThemeEnum)
                return PostTextMarkdownToPdfRequest.ThemeEnumToJsonValue(postTextMarkdownToPdfRequestThemeEnum);
            ...
            if (obj is PostWatermarkProducerCodeRequest.BindingEnum postWatermarkProducerCodeRequestBindingEnum)
                return PostWatermarkProducerCodeRequest.BindingEnumToJsonValue(postWatermarkProducerCodeRequestBindingEnum);
            if (obj is PostWatermarkProducerCodeRequest.ServiceTypeEnum postWatermarkProducerCodeRequestServiceTypeEnum)
                return PostWatermarkProducerCodeRequest.ServiceTypeEnumToJsonValue(postWatermarkProducerCodeRequestServiceTypeEnum);
            if (obj is PostWatermarkProducerCodeRequest.SubjectTypeEnum postWatermarkProducerCodeRequestSubjectTypeEnum)
                return PostWatermarkProducerCodeRequest.SubjectTypeEnumToJsonValue(postWatermarkProducerCodeRequestSubjectTypeEnum);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://uapis.cn";
        ...
        /// The host of the API
        /// </summary>
        public const string HOST = "uapis.cn";
