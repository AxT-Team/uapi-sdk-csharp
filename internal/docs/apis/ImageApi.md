...
# **GetAvatarGravatar**
> System.IO.Stream GetAvatarGravatar (string email = null, string hash = null, int s = null, string d = null, string r = null)
...
<a id="getimagebingdailyhistory"></a>
# **GetImageBingDailyHistory**
> GetImageBingDailyHistory200Response GetImageBingDailyHistory (string date = null, string resolution = null, int page = null, int pageSize = null)
...
| **pageSize** | **int** | 每页条数，必须是正整数。不传时默认是 &#x60;30&#x60;，最大是 &#x60;100&#x60;。只有在不传 &#x60;date&#x60; 时才生效。 | [optional] [default to 30] |
...
# **GetImageMotou**
> System.IO.Stream GetImageMotou (string qq, string bgColor = null)
...
| **bgColor** | **string** | GIF的背景颜色。留空则由后端服务决定默认值。 | [optional]  |
...
# **GetImageQrcode**
> System.IO.Stream GetImageQrcode (string text, int size = null, string format = null, bool transparent = null, string fgcolor = null, string bgcolor = null)
...
# **GetImageTobase64**
> GetImageTobase64200Response GetImageTobase64 (string url)
...
# **PostImageCompress**
> System.IO.Stream PostImageCompress (System.IO.Stream file, int level = null, string format = null)
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **file** | **System.IO.Stream****System.IO.Stream** | 支持PNG, JPG, JPEG等常见图片格式。文件大小不超过15MB。 |  |
...
<a id="postimagedecode"></a>
# **PostImageDecode**
> System.IO.Stream PostImageDecode (int width = null, int height = null, int maxWidth = null, int maxHeight = null, string format = null, string colorMode = null, string fit = null, string background = null, System.IO.Stream file = null, string url = null)
...
| **maxWidth** | **int** | 最大宽度，单位是像素。只有在不传 &#x60;width&#x60;、&#x60;height&#x60; 时才生效，会按原比例缩放。 | [optional]  |
| **maxHeight** | **int** | 最大高度，单位是像素。只有在不传 &#x60;width&#x60;、&#x60;height&#x60; 时才生效，会按原比例缩放。 | [optional]  |
| **format** | **string** | 输出格式。可以传 &#x60;bmp&#x60;、&#x60;rgb565&#x60; 或 &#x60;rgb888&#x60;，不传时默认是 &#x60;bmp&#x60;。 | [optional] [default to bmp] |
| **colorMode** | **string** | BMP 输出的颜色模式。只有在 &#x60;format&#x3D;bmp&#x60; 时才生效，可以传 &#x60;RGB565&#x60; 或 &#x60;RGB888&#x60;，不传时默认是 &#x60;RGB888&#x60;。 | [optional] [default to RGB888] |
...
| **file** | **System.IO.Stream****System.IO.Stream** | 要处理的图片文件。这个接口适合直接上传 JPG、JPEG、PNG、WebP、BMP 等常见格式。 | [optional]  |
...
# **PostImageFrombase64**
> PostImageFrombase64200Response PostImageFrombase64 (PostImageFrombase64Request postImageFrombase64Request)
...
# **PostImageNsfw**
> PostImageNsfw200Response PostImageNsfw (System.IO.Stream file = null, string url = null)
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **file** | **System.IO.Stream****System.IO.Stream** | 要检测的图片文件。支持 JPG、JPEG、PNG、GIF、WebP 格式，最大 20MB。 | [optional]  |
...
# **PostImageSpeechless**
> System.IO.Stream PostImageSpeechless (PostImageSpeechlessRequest postImageSpeechlessRequest)
...
<a id="postimagesvg"></a>
# **PostImageSvg**
> System.IO.Stream PostImageSvg (string format = null, int width = null, int height = null, int quality = null, System.IO.Stream file = null)
...
| **file** | **System.IO.Stream****System.IO.Stream** | 支持SVG文件 | [optional]  |
