# uapi-sdk-csharp.Api.WebParseApi
...
> GetWebTomarkdownAsyncStatus200Response GetWebTomarkdownAsyncStatus (string taskId)
...
> GetWebparseExtractimages200Response GetWebparseExtractimages (string url)
...
# **GetWebparseMetadata**
> GetWebparseMetadata200Response GetWebparseMetadata (string url)
...
> PostWebTomarkdownAsync202Response PostWebTomarkdownAsync (string url)
